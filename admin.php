    ...
    <section class="admin-section">
        ...
        ?>
            <div class="container orders-field">
                <div class="order-filters col-lg-5 d-flex justify-content-lg-center">
                    <form action="admin.php" method="post"><input type="hidden" value="3" name="zapros-type-all"><button type="submit" class="filter-button filter-1" name="show_all"><?php echo ' <p class="regular-text" >Всі</p> ' ?></button></form>
                    <form action="admin.php" method="post"><input type="hidden" value="0" name="zapros-type-new"><button class="filter-button filter-2" name="show_new"><?php echo ' <p class="regular-text" >Нові</p> ' ?></button></form>
                    <form action="admin.php" method="post"><input type="hidden" value="1" name="zapros-type-processing"><button class="filter-button filter-3" name="show_processing"><?php echo ' <p class="regular-text" >Виконуються</p> ' ?></button></form>
                    <form action="admin.php" method="post"><input type="hidden" value="2" name="zapros-type-done"><button class="filter-button filter-4" name="show_done"><?php echo ' <p class="regular-text" >Виконані</p> ' ?></button></form>
                        ...
                        <div class="order col-lg-8">
                            ...
                            ?>
                                <div class="editing col-lg-6">
                                    ...
                                    <form class=" editing col-lg-8" action="admin.php" method="POST">
                                        <input type="hidden" value="<?php echo $order->id; ?>" name="editOrder">

                                        <button type="submit" class="order-move-new-button order-edit-button" name="move_new">Нова</button>
                                        <button type="submit" class="order-move-processing-button order-edit-button" name="move_processing">Виконується</button>
